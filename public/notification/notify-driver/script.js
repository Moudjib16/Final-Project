...
let notElements = document.querySelectorAll(".not");
    ...
    notElements.forEach(n => {
      n.addEventListener("click", function() {
        ...
        if(gender === "female")
        {
            document.getElementById("leftbar").childNodes[1].childNodes[1].src="/notification/notify-driver/pics/female.svg"
         
           
        }
        else
        {
             document.getElementById("leftbar").childNodes[1].childNodes[1].src="/notification/notify-driver/pics/pfp.svg"
        }

        if(signal==1){
           
            document.getElementById("leftbar").childNodes[13].innerText="1" ;
        }else
        {
            document.getElementById("leftbar").childNodes[13].innerText="0" ; 
        }
