...
let guest_imglist = ["pics/menu-icons/log.png", "pics/menu-icons/sign.png"];
...
guest_pagelist = ["../sign_login/auth.html", "../sign_login/auth.html"];
...
function addoption(content, img_src, page) {
  ...
  if (
    page === "../sign_login/auth.html" &&
    img_src === "pics/menu-icons/sign.png" &&
    user.type === types[0]
  ) {
    page = page + "?param=";
...
switch (user.type) {
  case types[0]:
    create(guest_options, guest_imglist, guest_pagelist);
    break;
  case types[1]:
    create(client_options, client_imglist, client_pagelist);
    break;
  case types[2]:
    create(driver_options, driver_imglist, driver_pagelist);
    break;
  case types[3]:
    create(admin_options, admin_imglist, admin_pagelist);
    break;
}
