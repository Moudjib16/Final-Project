...
Trajet={
    ...
    gmail: queryParams.gmail    
}
console.log( queryParams.gmail);
...
const commentsLink = document.getElementById('link');
console.log(queryParams.gmail);
const queryParam = queryParams.gmail;

console.log(queryParam);

commentsLink.href = `../comments?${queryParam}`;